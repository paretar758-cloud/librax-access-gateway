    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          Back to {exam.name} Details
        </Button>

        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">{exam.name} Preparation Roadmap</h1>
          <p className="text-lg text-muted-foreground">{exam.fullName}</p>
          <p className="text-xl text-muted-foreground mt-2">Follow this path from start to finish</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <Card className="flex-1">
                <CardContent className="p-6">
                  <h3 className="text-2xl font-bold">Begin Your Preparation</h3>
                  <p className="text-muted-foreground mt-2">
                    Follow the steps below to prepare for {exam.name}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Card className="flex-1">
                <CardContent className="p-6">
                  <h3 className="text-2xl font-bold">All the Best! 🎯</h3>
                  <p className="text-muted-foreground mt-2">
                    You're now prepared for {exam.name}. Stay confident and give your best!
                  </p>
                </CardContent>
              </Card>
            </div>
...
export default FullExamRoadmap;
